...
<view class="verify-name">
    ...
    <view class="p-lr-30 p-top-25">
        ...
        <input class="p-lr-30 m-tb-25" placeholder="请输入姓名" :disabled="info_user.is_certify === 1 ? true : false" type='text' v-model="name" />
    </view>
    <view class="p-lr-30 ">
        ...
        <input class="p-lr-30 m-tb-25" maxlength="20" placeholder="请输入身份证号码" :disabled="info_user.is_certify === 1 ? true : false" type='idcard' v-model="idCard" />

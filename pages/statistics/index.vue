...
<view class="statistics">
    ...
    <view class="table m-top-10">
        <view class="item" @click="toDeatil(index)" :style="{backgroundImage:`url(/static/images/data/0${index}.png)`}" v-for="(i,index) in list" :key="i">
...
export default {
    ...
    methods: {
        toDeatil(index) {
            if (index === 5) return this.$showToast('正在开发中')
            uni.navigateTo({

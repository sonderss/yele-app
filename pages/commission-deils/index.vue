...
<view class="commission p-tb-20 p-lr-30">
    ...
    <view class="card p-lr-20 p-bottom-10 m-bottom-20" v-if="list.commission_type === 2 || list.commission_type === 6 || list.commission_type === 3 || list.commission_type === 7  || list.commission_type === 8 || list.commission_type === 9 || list.commission_type === 10 || list.commission_type === 11">
    ...
    <!-- 基础提成 -->
    <view class="card p-lr-20 p-bottom-10 m-bottom-20" v-if="list.commission_type === 0 || list.commission_type === 1 || list.commission_type === 3 || list.commission_type === 4  || list.commission_type === 5 || list.commission_type === 6">
        ...
        <view class="m-bottom-10 m-top-20 t" style="width:100%;display: flex;justify-content: space-between;" v-if="list.commission_type !== 3 &&  list.commission_type !== 6">
            <text class="f28">业绩</text>
            <text class="f26">￥{{list.performance_total ? list.performance_total : 0}}</text>
        </view>
        <view class="table_view" v-if="list.product_list.length">
            <min-table :lists="list.product_list"></min-table>
        </view>
    </view>
    <!-- 充公酒 -->
    <view class="card p-lr-20 p-bottom-10 m-bottom-20" v-if="list.commission_type === 12">
        <view class="p-tb-30 min-border-bottom q">充公信息</view>
        <view class="m-bottom-10 m-top-20 t" style="width:100%;display: flex;justify-content: space-between;">
            <text class="f28">充公人</text>
            <text class="f26">{{list.confiscate_user_name }}</text>
        </view>
        <view class="m-bottom-10 m-top-20 t" style="width:100%;display: flex;justify-content: space-between;">
            <text class="f28">充公单号</text>
            <text class="f26">{{list.confiscate_sn}}</text>
        </view>
        <view class="m-bottom-10 m-top-20 t" style="width:100%;display: flex;justify-content: space-between;">
            <text class="f28">充公时间</text>

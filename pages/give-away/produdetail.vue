...
<view class="product-details p-tb-20 p-lr-30">
    ...
    <view class="goods-item p-lr-20 m-bottom-20" v-if="!noData">
        <view class="top-view f28 f28" v-if="product_type === 'product' ">{{list.product_name}}</view>
        <view class="top-view f28  f28" v-if="product_type === 'service' ">{{list.product_name}}</view>

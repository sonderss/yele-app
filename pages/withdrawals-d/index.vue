...
<view class="withdrawaldetails p-tb-20 p-lr-30">
    ...
    <view v-if="type===1" class="m-top-20">
        <view v-for="(item,index) in list.grant_list" :key="index" class="m-bottom-20 view_main p-lr-20">
            <view>
                <view class="min-border-bottom" style="height:87rpx;line-height:87rpx">{{$minCommon.formatDate(new Date(item.cycle_start_time*1000),"yyyy/MM/dd")}}-{{$minCommon.formatDate(new Date(item.cycle_end_time*1000),"MM/dd")}}{{list.grant_type === 1 ? '工资':'提成'}}</view>
                <view class="bottom-view">
    ...
    <view class="view_main p-lr-20" v-if="type=== 2">
        <view class="top_view min-border-bottom">
            <text class="desc">金额</text>
            <text :class=" list.transaction_status === 1  ? 'money':'delcolor'">{{list.amount}}元</text>
        </view>
        <view class="bottom-view">
            <view class="main min-flex min-flex-main-between">
    ...
    <view class="view_main p-lr-20" v-if="type=== 3">
        <view class="top_view min-border-bottom">
            <text class="desc">金额</text>
            <text :class="list.transaction_status !== 1  ? 'delcolor':'money'">{{list.amount}}</text>
        </view>
        <view class="bottom-view">
            <view class="main min-flex min-flex-main-between">
                <text class="c">类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;型</text>
            ...
            <view class="main min-flex min-flex-main-between" v-if="list.transaction_status === 1">
                ...
                <view class="m-left-20">{{$minCommon.formatDate(new Date(list.arrive_time*1000),"yyyy/MM/dd hh:mm:ss") }}</view>
            </view>
            <view class="main min-flex min-flex-main-between" v-if="list.transaction_status === 2">

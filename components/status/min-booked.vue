                    ...
                    if (e.id === 1) {
                        this.$minApi.backBooked({
                            ...
                            .then(res => {
                                ...
                                // this.list.store_setting.booking_delay_setting.delay_time * 60
                                this.list.desk_info.arrival_time = (this.list.desk_info.arrival_time * 1) + this.list.store_setting.booking_delay_setting.delay_time * 60
                            })
                            .catch(err => {
                                console.log(err)
                            })
